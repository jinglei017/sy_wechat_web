$(function(){
	...
	$(".todayStat li").click(function(){
		...
		location.href = "clientList.html?orderstate="+index;
	})
	
	$(".weekStat li").click(function(){
		var index = $(this).index();
		location.href = "monthClientList.html?orderstate="+index+"&timeType=1";
	})
	
	$(".monthStat li").click(function(){
		var index = $(this).index();
		location.href = "monthClientList.html?orderstate="+index+"&timeType=2";
	})
	//bl   taoc   123456
	function p(s) {
	    return s < 10 ? '0' + s: s;
